...
<head>
    ...
    <script src="${base}/js/locales/fr.js" type="text/javascript"></script>
    <script src="${base}/js/locales/es.js" type="text/javascript"></script>
...
<div class="container kv-main">
    ...
    <form enctype="multipart/form-data">
        ...
        <br>
        <input id="file-0a" class="file" type="file" multiple data-min-file-count="2">
        <br>
